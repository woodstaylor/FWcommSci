...
# Top model
state.mod = get.models(mod.sel, subset = 1)[[1]]
summary(state.mod)
...
plot(simulationOutput.st)

# Test for dispersion
testDispersion(simulationOutput.st)
# data:  simulationOutput
# ratioObsSim = 1.6874, p-value = 0.136
...
# Top model
count.mod = get.models(mod.sel, subset = 1)[[1]]
...
r.squaredGLMM(count.mod)
#                R2m       R2c
# delta     0.4153530 0.8002972
# lognormal 0.4391956 0.8462370
# trigamma  0.3764012 0.7252453

performance::r2(count.mod)

# Checking residuals
simulationOutput.ct = simulateResiduals(fittedModel = count.mod)
plot(simulationOutput.ct)

# Test for overdispersion
testDispersion(simulationOutput.ct)
# data:  simulationOutput
# ratioObsSim = 1.0036, p-value = 0.648
# alternative hypothesis: two.sided
...
# Top model
ws.mod = get.models(mod.sel, subset = 1)[[1]]
summary(ws.mod)
# Estimate Std. Error z value Pr(>|z|)    
...
plot(simulationOutput.ws)

# Test for overdispersion
testDispersion(simulationOutput.ws)
# data:  simulationOutput
# ratioObsSim = 0.64693, p-value = 0.808
# alternative hypothesis: two.sided
